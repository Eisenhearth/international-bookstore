...
function Navbar() {
  ...
  return (
    <div name='support' className='sticky top-0 w-full bg-white shadow-sm z-50'> 
      <div className='flex justify-between items-center h-24 max-w-screen-xl mx-auto'>
        <img className='h-12 md:h-14 cursor-pointer' src={Logo} alt="" />
      ...
      <div className={nav ? 'fixed left-0 top-0 w-[70%] h-full border-r border-r-gray-200 bg-white ease-in-out duration-500' : 'fixed left-[-100%]'}>
